...
@main def main(): Unit = {
  ...
  equation ~ "C3H8" + "O2" --> "H2O" + "CO2" in reaction:
    reactants:
      200.g of "C3H8"
    PRINT
  ...
  val carbonCombustionResult = equation ~ "C" + "O2" --> "CO2" in reaction:
    reactants:
      1e3.g of "C"
  val molCO2 = carbonCombustionResult.asSuccess amountOfProduct "CO2"
  equation ~ "CO2" + "NH3" --> "CO(NH2)2" + "H2O" in reaction:
    reactants:
      molCO2 of "CO2"
    PRINT
  ...
  equation ~ "KAg(CN)2" + "Zn" --> "Ag" + "Zn(CN)2" + "KCN" in reaction:
    reactants:
      37.27.g of "KAg(CN)2"
    PRINT
  ...
  equation ~ "OH^-" + "IO3^-" + "CrO2^-" --> "I^-" + "CrO4^2-" + "H2O" in reaction:
    reactants:
      0.06.mol of "IO3^-"
    PRINT
